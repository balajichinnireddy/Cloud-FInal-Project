...
$sql = "Update incident set D=concat(D,'---','$x') where Id='$y'";
$result=mysqli_query($con,$sql);

if ($result)
{
    echo "<h1 class='credentials'>Incident Description Updated<h1>";
}

else
{
    echo "<h1 class='credentials'>Incident Description failed to update<h1>";
}
