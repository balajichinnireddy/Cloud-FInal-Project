...
$sql = "select * from `change` where ID='$x'";
...
echo " <div class='credentials'>";
     echo "<h1 style='color:white;'>Change Tasks :";echo "</h1>";
   echo " </div>";



$sql = "select * from `ctask` where ID='$x'";
$result=mysqli_query($con,$sql);

echo "<table style='color:white;font-size:15px' border=1 style='border-collapse: collapse;'>";
echo
"<tr>
<th>Name</th>
<th>Assigned Group</th>
