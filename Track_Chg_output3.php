...
$sql = "Update `change` set N=concat(N,'---','$x') where Id='$y'";
$result=mysqli_query($con,$sql);

if ($result)
{
    echo "<h1 class='credentials'>Change Notes Updated<h1>";
}

else
{
    echo "<h1 class='credentials'>Change Notes failed to update<h1>";
}
